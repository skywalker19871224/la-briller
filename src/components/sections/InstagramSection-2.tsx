...
const posts: IGPost[] = [
    {
        ...
        caption: "0.04mmが変える、笑顔の概念。花びらより薄いジルコニアベニアが、歯を削らずに理想の白さを実現します。 #LaBriller #ジルコニアベニア",
        likes: 1248,
    ...
    },
    {
        ...
        caption: "BEFORE → AFTER。スキャンから貼付まで、わずか2回の通院で完成するプレミアムスマイル。 #審美歯科 #パルフェクリニック",
        likes: 850,
        postUrl: "#",
    },
    {
        ...
        caption: "表参道の空。Aoビル3Fに広がる、プライベートクリニックの穏やかな時間。 #表参道 #完全個室",
        likes: 2104,
        postUrl: "#",
    },
    {
        ...
        caption: "ジルコニアが持つ、真珠のような透過性。色選択可能なので、あなただけの白さを選べます。 #ジルコニア #オーダーメイド",
        likes: 1502,
        postUrl: "#",
    },
    {
        ...
        caption: "STEP 01 スキャン / STEP 02 貼付。たった2回の通院でセレブリティの笑顔へ。 #通院2回 #短期間",
        likes: 920,
        postUrl: "#",
    },
    {
        ...
        caption: "美しさに対して、妥協しない。パルフェクリニック総院長が、La Brillerをパートナーに選んだ理由。 #総院長 #信頼",
        likes: 3401,
        postUrl: "#",
    },
];

const PEEK_WIDTH = 80; // px: 次のカードが覗く幅
        ...
        >
            <div className="container mx-auto px-6">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <p className="text-[10px] tracking-[0.4em] uppercase text-gray-400 mb-1">Official SNS</p>
                ...
                {/* Slider Container: 1.5 peek layout */}
                <div className="relative">
                    <div
                        className="flex transition-transform duration-400 ease-out"
                        style={{
                            transform: `translateX(calc(-${currentIndex * 100}% - ${currentIndex * 16}px + ${currentIndex > 0 ? -PEEK_WIDTH / 2 : 0}px))`,
                            gap: "16px",
                        }}
                    >
